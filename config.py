...
OWNER_ID = int(getenv("OWNER_ID", 6513080431))
...
UPSTREAM_REPO = getenv(
    "UPSTREAM_REPO",
    "https://github.com/jk21fire/BrandrdXMusic",
)
...
SUPPORT_CHANNEL = getenv("SUPPORT_CHANNEL", "https://t.me/tc1minute_wingo")
SUPPORT_CHAT = getenv("SUPPORT_CHAT", "https://t.me/tc_lottery_hack_pridction")
